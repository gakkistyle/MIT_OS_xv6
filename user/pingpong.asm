...
main(int argc, char *argv[])
{
  ...
  1e:	38a080e7          	jalr	906(ra) # 3a4 <pipe>
    char byte[] = "a";
  22:	06100793          	li	a5,97
  26:	f6f41023          	sh	a5,-160(s0)

    pid = fork();
  2a:	00000097          	auipc	ra,0x0
  2e:	362080e7          	jalr	866(ra) # 38c <fork>

    if(pid == 0) {
  32:	ed25                	bnez	a0,aa <main+0xaa>
        n = read(fds[0], buf, sizeof(buf));
  34:	06400613          	li	a2,100
  38:	f6840593          	addi	a1,s0,-152
  3c:	fd842503          	lw	a0,-40(s0)
  40:	00000097          	auipc	ra,0x0
  44:	36c080e7          	jalr	876(ra) # 3ac <read>
  48:	84aa                	mv	s1,a0
        if (n > 0) {
  4a:	02a05d63          	blez	a0,84 <main+0x84>
            printf("%d: received ping\n", getpid());
  4e:	00000097          	auipc	ra,0x0
  52:	3c6080e7          	jalr	966(ra) # 414 <getpid>
  56:	85aa                	mv	a1,a0
  58:	00001517          	auipc	a0,0x1
  5c:	85850513          	addi	a0,a0,-1960 # 8b0 <malloc+0xe6>
  60:	00000097          	auipc	ra,0x0
  64:	6ac080e7          	jalr	1708(ra) # 70c <printf>
            write(fds2[1], buf, n);
  68:	8626                	mv	a2,s1
  6a:	f6840593          	addi	a1,s0,-152
  6e:	fd442503          	lw	a0,-44(s0)
  72:	00000097          	auipc	ra,0x0
  76:	342080e7          	jalr	834(ra) # 3b4 <write>
            exit(0);
  7a:	4501                	li	a0,0
  ...
  88:	390080e7          	jalr	912(ra) # 414 <getpid>
  8c:	862a                	mv	a2,a0
  8e:	00001597          	auipc	a1,0x1
  92:	83a58593          	addi	a1,a1,-1990 # 8c8 <malloc+0xfe>
  96:	4509                	li	a0,2
  98:	00000097          	auipc	ra,0x0
  9c:	646080e7          	jalr	1606(ra) # 6de <fprintf>
        exit(1);
  a0:	4505                	li	a0,1
  a2:	00000097          	auipc	ra,0x0
  a6:	2f2080e7          	jalr	754(ra) # 394 <exit>
    } else {
        write(fds[1], byte, sizeof(byte));
  aa:	4609                	li	a2,2
  ac:	f6040593          	addi	a1,s0,-160
  b0:	fdc42503          	lw	a0,-36(s0)
  b4:	00000097          	auipc	ra,0x0
  b8:	300080e7          	jalr	768(ra) # 3b4 <write>
        n = read(fds2[0], buf, sizeof(buf));
  bc:	06400613          	li	a2,100
  c0:	f6840593          	addi	a1,s0,-152
  c4:	fd042503          	lw	a0,-48(s0)
  c8:	00000097          	auipc	ra,0x0
  cc:	2e4080e7          	jalr	740(ra) # 3ac <read>
        if (n > 0) {
  d0:	02a05463          	blez	a0,f8 <main+0xf8>
            printf("%d: received pong\n", getpid());
  d4:	00000097          	auipc	ra,0x0
  d8:	340080e7          	jalr	832(ra) # 414 <getpid>
  dc:	85aa                	mv	a1,a0
  de:	00001517          	auipc	a0,0x1
  e2:	80a50513          	addi	a0,a0,-2038 # 8e8 <malloc+0x11e>
  ...
  fc:	31c080e7          	jalr	796(ra) # 414 <getpid>
 100:	862a                	mv	a2,a0
 102:	00000597          	auipc	a1,0x0
 106:	7fe58593          	addi	a1,a1,2046 # 900 <malloc+0x136>
 10a:	4509                	li	a0,2
