...
0000000000000000 <do_subroutine>:
...
void do_subroutine() {
   ...
   c:	3e6080e7          	jalr	998(ra) # 3ee <fork>

    if (pid == 0) {
  10:	c911                	beqz	a0,24 <do_subroutine+0x24>
        exec(_argv[0], _argv);
        exit(0);
    }
    wait(0);
  ...
  18:	3ea080e7          	jalr	1002(ra) # 3fe <wait>
}
  1c:	60a2                	ld	ra,8(sp)
  1e:	6402                	ld	s0,0(sp)
  ...
  28:	93458593          	addi	a1,a1,-1740 # 958 <_argv>
  2c:	6188                	ld	a0,0(a1)
  2e:	00000097          	auipc	ra,0x0
  32:	400080e7          	jalr	1024(ra) # 42e <exec>
        exit(0);
  36:	4501                	li	a0,0
  38:	00000097          	auipc	ra,0x0
  3c:	3be080e7          	jalr	958(ra) # 3f6 <exit>

0000000000000040 <main>:

int main(int argc, char *argv[])
{
  40:	715d                	addi	sp,sp,-80
  42:	e486                	sd	ra,72(sp)
  44:	e0a2                	sd	s0,64(sp)
  46:	fc26                	sd	s1,56(sp)
  48:	f84a                	sd	s2,48(sp)
  ...
  4e:	0880                	addi	s0,sp,80
    if (argc < 2) {
  50:	4785                	li	a5,1
  52:	06a7db63          	bge	a5,a0,c8 <main+0x88>
  56:	89aa                	mv	s3,a0
  58:	892e                	mv	s2,a1
  ...
  5a:	00001497          	auipc	s1,0x1
  5e:	8fe48493          	addi	s1,s1,-1794 # 958 <_argv>
  62:	10000613          	li	a2,256
  66:	4581                	li	a1,0
  68:	8526                	mv	a0,s1
  6a:	00000097          	auipc	ra,0x0
  6e:	188080e7          	jalr	392(ra) # 1f2 <memset>
    _argc = argc - 1;
  72:	fff9879b          	addiw	a5,s3,-1
  76:	00001717          	auipc	a4,0x1
  7a:	8cf72923          	sw	a5,-1838(a4) # 948 <_argc>
    for (int i = 1; i < argc; i++) {
  7e:	00890593          	addi	a1,s2,8
  82:	87a6                	mv	a5,s1
  84:	ffe9871b          	addiw	a4,s3,-2
  88:	1702                	slli	a4,a4,0x20
  8a:	9301                	srli	a4,a4,0x20
  8c:	070e                	slli	a4,a4,0x3
  8e:	00001697          	auipc	a3,0x1
  92:	8d268693          	addi	a3,a3,-1838 # 960 <_argv+0x8>
  96:	9736                	add	a4,a4,a3
        _argv[i - 1] = argv[i];
  98:	6194                	ld	a3,0(a1)
  9a:	e394                	sd	a3,0(a5)
    for (int i = 1; i < argc; i++) {
  9c:	05a1                	addi	a1,a1,8
  9e:	07a1                	addi	a5,a5,8
  a0:	fee79ce3          	bne	a5,a4,98 <main+0x58>
    }
  ...
  ae:	3a4080e7          	jalr	932(ra) # 44e <fstat>
  b2:	02054963          	bltz	a0,e4 <main+0xa4>
        }
        if (buf[0]) {
            do_subroutine();
        }
  ...
  ba:	f4a080e7          	jalr	-182(ra) # 0 <do_subroutine>
    }

    exit(0);
  be:	4501                	li	a0,0
  c0:	00000097          	auipc	ra,0x0
  c4:	336080e7          	jalr	822(ra) # 3f6 <exit>
        fprintf(2, "xargs: too few args\n");
  c8:	00001597          	auipc	a1,0x1
  cc:	84858593          	addi	a1,a1,-1976 # 910 <malloc+0xe4>
  d0:	4509                	li	a0,2
  d2:	00000097          	auipc	ra,0x0
  d6:	66e080e7          	jalr	1646(ra) # 740 <fprintf>
        exit(-1);
  da:	557d                	li	a0,-1
  dc:	00000097          	auipc	ra,0x0
  e0:	31a080e7          	jalr	794(ra) # 3f6 <exit>
        _argv[_argc] = buf;
  e4:	00001797          	auipc	a5,0x1
  e8:	8647a783          	lw	a5,-1948(a5) # 948 <_argc>
  ec:	00379713          	slli	a4,a5,0x3
  f0:	00001797          	auipc	a5,0x1
  f4:	86878793          	addi	a5,a5,-1944 # 958 <_argv>
  f8:	97ba                	add	a5,a5,a4
  fa:	00001517          	auipc	a0,0x1
  fe:	95e50513          	addi	a0,a0,-1698 # a58 <buf>
 102:	e388                	sd	a0,0(a5)
        memset(buf, 0, sizeof(buf));
 104:	20000613          	li	a2,512
 108:	4581                	li	a1,0
 10a:	00000097          	auipc	ra,0x0
 10e:	0e8080e7          	jalr	232(ra) # 1f2 <memset>
        int pos = 0;
 112:	4481                	li	s1,0
        while(read(0, &buf[pos], 1) > 0) {
 114:	00001917          	auipc	s2,0x1
 118:	94490913          	addi	s2,s2,-1724 # a58 <buf>
            if (buf[pos] == '\n') {
 11c:	00001997          	auipc	s3,0x1
 120:	83c98993          	addi	s3,s3,-1988 # 958 <_argv>
 124:	4a29                	li	s4,10
        while(read(0, &buf[pos], 1) > 0) {
 126:	a00d                	j	148 <main+0x108>
                buf[pos] = 0;
 128:	94ce                	add	s1,s1,s3
 12a:	10048023          	sb	zero,256(s1)
                do_subroutine();
 12e:	00000097          	auipc	ra,0x0
 132:	ed2080e7          	jalr	-302(ra) # 0 <do_subroutine>
                memset(buf, 0, sizeof(buf));
 136:	20000613          	li	a2,512
 13a:	4581                	li	a1,0
 13c:	854a                	mv	a0,s2
 13e:	00000097          	auipc	ra,0x0
 142:	0b4080e7          	jalr	180(ra) # 1f2 <memset>
                pos = 0;
 146:	4481                	li	s1,0
        while(read(0, &buf[pos], 1) > 0) {
 148:	4605                	li	a2,1
 14a:	009905b3          	add	a1,s2,s1
 14e:	4501                	li	a0,0
 150:	00000097          	auipc	ra,0x0
 154:	2be080e7          	jalr	702(ra) # 40e <read>
 158:	00a05a63          	blez	a0,16c <main+0x12c>
            if (buf[pos] == '\n') {
 15c:	009987b3          	add	a5,s3,s1
 160:	1007c783          	lbu	a5,256(a5)
 164:	fd4782e3          	beq	a5,s4,128 <main+0xe8>
                pos++;
 168:	2485                	addiw	s1,s1,1
 16a:	bff9                	j	148 <main+0x108>
        if (buf[0]) {
 16c:	00001797          	auipc	a5,0x1
 170:	8ec7c783          	lbu	a5,-1812(a5) # a58 <buf>
 174:	d7a9                	beqz	a5,be <main+0x7e>
            do_subroutine();
 176:	00000097          	auipc	ra,0x0
 17a:	e8a080e7          	jalr	-374(ra) # 0 <do_subroutine>
 17e:	b781                	j	be <main+0x7e>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4de:	45650513          	addi	a0,a0,1110 # 930 <digits>
 4e2:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5aa:	38ab8b93          	addi	s7,s7,906 # 930 <digits>
 ...
 6ea:	24290913          	addi	s2,s2,578 # 928 <malloc+0xfc>
        while(*s != 0){
...
free(void *ap)
{
 ...
 7b2:	1a27b783          	ld	a5,418(a5) # 950 <freep>
 ...
 7e0:	00e6ea63          	bltu	a3,a4,7f4 <free+0x50>
{
 ...
 822:	12f73923          	sd	a5,306(a4) # 950 <freep>
}
 826:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 854:	10053503          	ld	a0,256(a0) # 950 <freep>
 ...
 87c:	0d890913          	addi	s2,s2,216 # 950 <freep>
  if(p == (char*)-1)
 880:	5afd                	li	s5,-1
 882:	a88d                	j	8f4 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 884:	00000797          	auipc	a5,0x0
 888:	3d478793          	addi	a5,a5,980 # c58 <base>
 88c:	00000717          	auipc	a4,0x0
 890:	0cf73223          	sd	a5,196(a4) # 950 <freep>
 894:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 8b6:	08a73f23          	sd	a0,158(a4) # 950 <freep>
      return (void*)(p + 1);
